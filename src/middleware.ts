...
export const config = {
    matcher: [
        ...
        "/entregas-recepciones-pendientes/[deliveryReceptionId]",
        "/entregas-recepciones-en-proceso",
        "/entregas-recepciones-en-proceso/[deliveryReceptionId]",
        "/entregas-recepciones-liberadas",
        "/entregas-recepciones-liberadas/[deliveryReceptionId]",
        "/entregas-recepciones-realizadas",
        "/entregas-recepciones-realizadas/[deliveryReceptionId]",
        "/entregas-recepciones-realizadas/nueva",
        "/entregas-recepciones-realizadas/edicion/[deliveryReceptionId]",
        "/entregas-recepciones-recibidas/[deliveryReceptionId]",
        "/usuarios",
        "/usuarios/nuevo",
